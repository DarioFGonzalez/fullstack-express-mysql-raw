...
const loginClient = async (req, res) => {
    ...
    try {
        ...
        const cliente = { id: client[0].id, business_name: client[0].business_name, is_active: client[0].is_active, email: client[0].email };
        ...
        const token = jwt.sign( { id: client[0].id, business_name: client[0].business_name }, process.env.JWT_SECRET, {expiresIn: '7d'} );
